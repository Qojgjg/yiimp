...
bool coind_validate_address(YAAMP_COIND *coind)
{
	...
	json_value *json;
    bool getaddressinfo = ((strcmp(coind->symbol,"DGB") == 0) || (strcmp(coind->symbol2, "DGB") == 0) || (strcmp(coind->symbol, "BZAR") == 0) || (strcmp(coind->symbol2,"BZAR") == 0) ||(strcmp(coind->symbol,"BSTR") == 0) || (strcmp(coind->symbol2, "BSTR") == 0));	
	if(getaddressinfo)
...
void coind_init(YAAMP_COIND *coind)
{
    ...
    if (is_dgb) {
	    ...
	    bool is_bstr = ((strcmp(coind->symbol,"BSTR") == 0) || (strcmp(coind->symbol2, "BSTR") == 0));
