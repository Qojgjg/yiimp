...
void coind_init(YAAMP_COIND *coind)
{
    ...
    if (is_dane) {
        ...
        json = rpc_call(&coind->rpc, "getnewaddress", params);
		    ...
		    bool is_chi = ((strcmp(coind->symbol,"CHI") == 0) || (strcmp(coind->symbol2, "CHI") == 0));
